...
function build_drs_object(obj_id, expand, data, cb) {
    ...
    obj.set_description(data['description']);
    obj.set_md5_checksum(data['md5_checksum']);
    obj.set_sha256_checksum(data['sha256_checksum']);
    obj.set_mime_type(data['mime_type']);
    obj.set_name(data['name']);
    obj.set_updated_time(data['updated_time']);
    obj.set_version(data['version']);
